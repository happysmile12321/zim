...
import Worker from "./MuWorker.js?worker"
class MuWrapper {
    async loadModule() {

        // console.log(import.meta.url)
        // const worker = new Worker('/MuWorker.js?type=module&worker_file');

        // fail, vite do special handler
        // const worker = new Worker(new URL('/MuWorker.js', url), {
        //     type: 'module'
        // });
        ...
        // console.log(import.meta.url)
        // const worker = new Worker(new URL('/pdf/MuWorker.js', "http://localhost:6001/pdf/"), {
        //     type: 'module'
        // });
